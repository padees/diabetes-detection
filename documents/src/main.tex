...
Figure 2 shows that the Random Forest achieves perfect classification for prediabetes (0), type 1 diabetes (1), and type 3c diabetes (3) in both training and testing. Type 2 diabetes (2) is frequently misclassified as type 3c, with 411 training and 295 testing errors. This suggests significant feature overlap between type 2 and type 3c diabetes. Class separation is robust for prediabetes and type 1, but weak between type 2 and 3c.

From Figure 3, we can conclude that decision trees exhibit a worse misclassification ratio between type 2 and type 3c diabetes compared to other models. This indicates that the tree model struggles more with separating these two clinically similar classes. While classification of prediabetes and type 1 remains accurate, type 2 instances are more frequently mislabeled as type 3c. The rigid splits of decision trees likely fail to capture subtle feature distinctions. This suggests limited generalization for overlapping diabetes subtypes.

Figure 4 shows that the Discrete Bayes classifier shows excellent performance in distinguishing Prediabetes (0) and Type 1 diabetes (1), with near-perfect classification in both the training and testing sets, indicating clear separability of these classes. However, there is substantial confusion between Type 2 diabetes (2) and Type 3c diabetes (3), with 467 Type 2 samples misclassified as Type 3c in training and 204 in testing, and 610 Type 3c samples misclassified as Type 2 in training and 270 in testing. This bidirectional misclassification, again suggests significant feature overlap between these two classes. The overall accuracy is high, with 92.81\% on the training set and 92.63\% on the testing set, indicating minimal overfitting. To improve classification performance, especially between Type 2 and Type 3c diabetes, enhanced feature engineering or additional discriminatory inputs is required.

Logistic Regression handles Prediabetes (0) and Type 1 (1) very well, nearly perfect in both train and test sets. Type 2 (2) and Type 3c (3) are frequently confused—898 training and 240 testing samples of Type 2 are misclassified as Type 3c, and 736 training and 189 testing samples of Type 3c are misclassified as Type 2. Accuracy drops to 89.98\% (train) and 89.48\% (test), worse than DB. Feature overlap between Type 2 and Type 3c severely degrades performance. Model is too simplistic for this distinction.
