...
\section{Methodology}
\subsection{Dataset}
A targeted set of physiologically relevant features was selected based on clinical significance and exploratory data analysis. These attributes were chosen to ensure effectiveness in both diabetes detection and subtype classification. The selection balances medical relevance with predictive utility.
